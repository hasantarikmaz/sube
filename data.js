...
const examData = {
    ...
    topics: [
        ...
        {
            id: 2,
            name: "Yönetimde İnsan İlişkileri",
            questionCount: 2,
            icon: "🤝",
            flashcards: [
        ...
        },
        {
            ...
            questions: [
                ...
                { q: "Aşağıdakilerden hangisi Marmara Bölgesi'nde yer almaz?", options: ["İstanbul", "Kocaeli", "Manisa", "Edirne"], answer: 2 }
            ]
        },
        {
            id: 10,
        ...
        },
        {
            ...
            flashcards: [
                ...
                { front: "Mecburi ilköğretim çağı kaç yaştır?", back: "6-13 yaş arası (6-13 yaş grubundaki çocukları kapsar)." },
        ...
        },
        {
            ...
            flashcards: [
                ...
                { front: "MEB merkez teşkilatı ana hizmet birimleri nelerdir?", back: "Temel Eğitim GM, Ortaöğretim GM, Meslekî ve Teknik Eğitim GM, Din Öğretimi GM, Özel Eğitim ve Rehberlik Hizmetleri GM, Hayat Boyu Öğrenme GM, vb." },
            ...
            questions: [
                { q: "MEB merkez teşkilatında bulunan danışma ve denetim birimi hangisidir?", options: ["Talim ve Terbiye Kurulu", "Teftiş Kurulu", "Strateji Geliştirme Başkanlığı", "Personel Genel Müdürlüğü"], answer: 1 },
        ...
        },
        {
            ...
            icon: "📋",
            flashcards: [
                { front: "2886 sayılı Kanun neyi düzenler?", back: "Genel bütçeye dahil daireler, katma bütçeli idareler, il özel idareleri ve belediyelerin alım, satım, hizmet, yapım, kira, trampa ve mülkiyetin gayri ayni hak tesisi işlerini düzenler." },
                { front: "Temel ihale usulleri nelerdir?", back: "Kapalı teklif usulü, belli istekliler arasında kapalı teklif usulü, açık teklif usulü, pazarlık usulü, yarışma usulü." },
                { front: "Geçici teminat oranı nedir?", back: "Tahmin edilen bedelin %3'ü." }
            ],
            questions: [
                { q: "2886 sayılı Kanuna göre geçici teminat oranı yüzde kaçtır?", options: ["%1", "%3", "%5", "%10"], answer: 1 },
                { q: "Aşağıdakilerden hangisi 2886 sayılı Kanundaki ihale usullerinden biri değildir?", options: ["Kapalı teklif", "Açık teklif", "Doğrudan temin", "Pazarlık"], answer: 2 }
            ]
        },
        {
            id: 18,
        ...
        },
        {
            ...
            flashcards: [
                ...
                { front: "Bucak müdürünün görevleri nelerdir?", back: "Bucak içindeki köylerin idaresinden sorumludur (Not: Bucak sistemi kaldırılmıştır)." }
            ],
            questions: [
        ...
        {
            id: 21,
            name: "5442 sayılı İl İdaresi Kanunu (Devam)",
            questionCount: 3,
            icon: "📍",
            flashcards: [
                { front: "Valinin görevleri nelerdir?", back: "İl sınırları içinde kanun, tüzük, yönetmelik ve hükümet kararlarının yayınlanmasını sağlamak, genel emir vermek, ilin huzur ve güvenliğini sağlamak." },
                { front: "Vali kararname ile mi atanır?", back: "Evet, valiler ortak kararname ile atanır ve görevden alınır." },
                { front: "Kaymakam nasıl atanır?", back: "İçişleri Bakanlığı tarafından atanır." }
            ],
            questions: [
        ...
        },
        {
            ...
            flashcards: [
                ...
                { front: "Sendika üyeliği nasıl sonlanır?", back: "Üyelikten çekilme, üyelikten çıkarılma, kamu görevlisi statüsünün sona ermesi." },
        ...
        },
        {
            ...
            icon: "🎒",
            flashcards: [
                { front: "Özel öğretim kurumları kimler tarafından açılabilir?", back: "Türkiye Cumhuriyeti uyruklu gerçek kişiler, özel hukuk tüzel kişileri veya özel hukuk hükümlerine göre yönetilen tüzel kişiler tarafından açılabilir." },
                { front: "Kurum açma izni kim tarafından verilir?", back: "Milli Eğitim Bakanlığı tarafından verilir." },
                { front: "Özel okulların denetimi kim tarafından yapılır?", back: "Milli Eğitim Bakanlığı tarafından yapılır." },
                { front: "Özel öğretim kurumlarının türleri nelerdir?", back: "Özel okullar, dershaneler, kurslar, özel eğitim ve rehabilitasyon merkezleri." }
            ],
            questions: [
